//Unfortunately, unlike other languages supported by this mod, you have to add the imports after converting to C# source
//Just do "using [nameWithoutQuotationmarks];" instead of "import * as [name] from [nameWithQuotationmarks];"
